<template>
  <div class="tree">
    <ZoningGrid v-show="showGrid" @close="closeSecondMenu"></ZoningGrid>
    <ResourceMenu
      :menu="resourceList"
      ...
      class="resource-menu"
    ></ResourceMenu>
    <TreeScene :list="currentItem" v-if="currentItem" class="second-menu" @close="closeSecondMenu"></TreeScene>
  </div>
</template>
