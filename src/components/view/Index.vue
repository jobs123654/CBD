<template>
  <div id="app">
    ...
    <SecondMenu
      ...
      :list="currentItem"
      :boundary="boundary"
      v-if="!showRealScene&&showSecondMenu"
      @close="closeSecondMenu"
    />
    <!--区域网格-->
    <GridMenu :list="areagrids"  @close="closeSecondMenu" v-show="showAreagrid "></GridMenu>
    <!--底图切换-->
    ...
    <!-- 高级查询 -->
    <MapSearch :class="$style.mapsearch" v-if="search" @closeSearch="closeSearch"></MapSearch>
    ...
    <InfoBoxForLink
      class="info-box"
      :infoData="galleryData"
      v-if="galleryData.data"
      ref="InfoBoxForLink"
    ></InfoBoxForLink>
    ...
    <div :class="$style.back" @click="back" v-show="showRight">
      <img src="../../assets/images/恢复.png"  title="返回首页">
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.$store.commit("setContent", this.$el);
    // 测试
  ...
  methods: {
    ...
    closeMenu() {
      ...
      this.showMapCollection = false;
      this.showUserInfo = false;
      this.search = false;
      this.showSecondMenu = true;
      this.showAreagrid = false;
      // this.$refs.InfoBoxForLink.infoBoxShow=false;
      // this.$refs.InfoBoxForLink.isShow=false;
