...
export default new Vuex.Store({
  ...
  actions: {
    ...
    clickMap(context, coordnate) {
      ...
      if (context.state.currentList.name == "楼宇分析"||context.state.currentList.name=='综合分析') {
    ...
    queryBuildings:function (context) {
      context.state.currentList.name = "楼宇分析"
    }
  }
});
